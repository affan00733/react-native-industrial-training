...
// let itemsRef = db.ref( '/root/items/physics/sample1' );
      ...
      handleSubmit() {
       ...
       this.setState({item : this.props.items,val : this.props.items[this.state.index].name})
        ...
        if(this.state.index <= this.props.items.length-1){
                    db.ref('/root/answers/physics/'+this.props.items[this.state.index].name).push().set(
      ...
      return (
        ...
        onChange={this.handleChange}
                      ...
                      <View style={{ padding: deviceHeight * 0.04 ,marginTop : deviceHeight * 0.2}}>
                                ...
                                <Text style={styles.itemtext}>{this.props.items[this.state.index].option1}</Text>
                                {/* <TextInput 
        placeholder = 'Answer'
